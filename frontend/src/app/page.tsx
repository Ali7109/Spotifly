	...
	return (
		<main className="min-h-screen bg-white dark:bg-black transition-colors duration-300">
			<div className="flex flex-col items-center justify-center h-screen w-full bg-red-400 dark:bg-black dark:text-red-400 transition-all duration-300">
				...
				<button className="mt-4 w-100 bg-black text-white px-4 py-2 rounded-full cursor-pointer hover:bg-white hover:text-black dark:bg-red-400 dark:text-black dark:hover:bg-black dark:hover:text-red-400 transition-all duration-300">
					Get started
				</button>
			</div>
		</main>
